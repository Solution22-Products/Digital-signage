...
const ModifySchedule = (props: Props) => {
  ...
  const fetchZoneData = async (currentValue: string | null) => {
  ...
  const handleScreenSelect = (currentValue: string | null) => {
    // Determine the selected value based on the current selection
    // const selectedValue =
    //   currentValue === selectedScreenValues ? null : currentValue;

    // Update the selected screen state
                                  ...
                                  <CommandGroup>
                                    {filteredScreens.map((screen: any) => (
                                      <CommandItem
                                        key={screen.id}
                                        value={screen.id}
                                        // onSelect={handleScreenSelect} // Use the handle function here
