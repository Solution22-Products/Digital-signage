...
const Screen = () => {
  ...
  const [screenFolderLoading, setScreenFolderLoading] = useState(true);
  ...
  return (
    <>
      ...
      {/* <SearchBar
        ...
        multipleScreenMoveFolder={multipleScreenMoveFolder}
        ...
        setSortedValue={(value: string | null) => setSortedValue(value)}
        ...
        deleteMultipleScreenFolderOpen={deleteMultipleScreenFolderOpen}
        setDeleteMultipleScreenFolderOpen={setDeleteMultipleScreenFolderOpen}
        ...
        // handleResetFilter={handleResetFilter as any}
