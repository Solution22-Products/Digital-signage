...
const CalendarPage = () => {
  ...
  const getScheduledEvents = async () => {
    ...
    if (error) {
      ...
      data.forEach((item: any) => {
        ...
        let randColor = generateRandomColor(0.3);
        ...
        if (item.repeat === null) {
          formattedEvents.push({
            ...
            start: startDateTime,
              ...
              new Date(endDateTime).setDate(new Date(endDateTime).getDate() + 1)
            ).toISOString(),
            allDay: false,
            id: item.id,
            ids: item.id,
  ...
  const handleEventClick = (clickInfo: any) => {
    ...
    // });
    console.log(clickInfo, " click event");
                  ...
                  <div className="mt-4">
                    {selectedEvent && (
                      <div>
                        ...
                        <p>{startDateCheck}</p>
                        <p className="mb-2">
                          <strong className="mr-[53px]">Schedule Date:</strong>
