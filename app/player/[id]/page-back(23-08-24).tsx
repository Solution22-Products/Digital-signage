...
const DynamicSlider: React.FC<Props> = ({ params: { id } }) => {
  ...
  if (
    ...
    layoutContent = (
      <div className="h-screen w-screen flex flex-wrap">
        <div className={`h-[${layoutZone.zone1h}px] overflow-hidden`}>
          <Slider {...settings} ref={sliderRef}>
            {zone1slides.map((slide, index) => (
              <div
                key={index}
        ...
        <div className={`h-[${layoutZone.zone2h}px] overflow-hidden`}>
          <Slider {...settings} ref={sliderRef}>
            {zone2slides.map((slide, index) => (
              <div
                key={index}
        ...
        <div className={`h-[${layoutZone.zone3h}px] overflow-hidden`}>
          <Slider {...settings} ref={sliderRef}>
            {zone3slides.map((slide, index) => (
              <div
                key={index}
    ...
    layoutContent = (
      <div className="h-screen w-screen">
        <div className={`h-[${layoutZone.zone1h}px]`}>
          <Slider {...settings} ref={sliderRef}>
            {zone1slides.map((slide, index) => (
              <div
                key={index}
        ...
        <div className={`h-[${layoutZone.zone2h}px]`}>
          <Slider {...settings} ref={sliderRef}>
            {zone2slides.map((slide, index) => (
              <div
                key={index}
        ...
        <div className={`h-[${layoutZone.zone3h}px]`}>
          <Slider {...settings} ref={sliderRef}>
            {zone3slides.map((slide, index) => (
              <div
                key={index}
    ...
    layoutContent = (
      <div className="h-screen w-screen">
        <div className={`w-[${layoutZone.zone1w}px]`}>
          <Slider {...settings} ref={sliderRef}>
            {zone1slides.map((slide, index) => (
              <div
                key={index}
        ...
        <div className={`w-[${layoutZone.zone2w}px]`}>
          <Slider {...settings} ref={sliderRef}>
            {zone2slides.map((slide, index) => (
              <div
                key={index}
