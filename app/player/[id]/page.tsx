...
*/
  ...
  // Usage
  // const settings1 = generateSliderSettings(zone1slides, currentSlideIndex1);
  // const settings2 = generateSliderSettings(zone2slides, currentSlideIndex2);
  // const settings3 = generateSliderSettings(zone3slides, currentSlideIndex3);
  ...
  // console.log("----------");
  // console.log("s1 index", currentSlideIndex1);
  // console.log("s2 index", currentSlideIndex2);
  // console.log("s3 index", currentSlideIndex3);
    ...
    if (
      ...
      layoutContent = (
        <div className="h-screen w-screen flex items-center justify-center bg-black">
          ...
          >
            <Slider {...settings1} ref={sliderRef1} className="w-full h-full">
